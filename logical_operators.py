def logical_operators():
  ...
  my_bool= word1 not in "When something is important enough, you do it even if the odds are against you." and word2 not in "When something is important enough, you do it even if the odds are against you."
  print(my_bool)
  # "When something is important enough, you do it even if the odds are against you" - Elon Musk
  ##################### end logical operators#############################################Z
